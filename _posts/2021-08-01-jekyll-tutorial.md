...
From now on, just build before pushing. I tested this with a main branch and a user site. I haven't tried other branches, or project or organization sites. It seems the only acceptable folders are . (root) and ./docs
...
### Changes not visible
This class of issues is fixed by having at least double digit IQ.
